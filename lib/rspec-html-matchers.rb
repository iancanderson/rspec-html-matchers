...
module RSpec
  module Matchers
    ...
    def with_or_without_option(with_option, text, value=nil, options={})
      options[:with] ||= {}
      if value.is_a?(Hash)
        options.merge!(value)
        value=nil
    ...
    def with_option text, value=nil, options={}
      with_or_without_option(true, text, value, options)
    end

    def without_option text, value=nil, options={}
      with_or_without_option(false, text, value, options)
    end
